...
# Handle missing values in categorical features: fill missing values with a placeholder
cat_features = [
...
# Use MaxAbsScaler for sparse data to scale features
scaler = MaxAbsScaler()
...
# Hyperparameter grid for LinearRegression (explore different fit_intercept options)
reg_param_grid = {
